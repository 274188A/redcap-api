...
/// <summary>
/// REDCap surveys API contract.
/// </summary>
public interface IRedcapSurveys
{
    /// <summary>
    ...
    Task<string> ExportSurveyLinkAsync(string record, string instrument, string eventName, int repeatInstance, RedcapReturnFormat returnFormat = RedcapReturnFormat.json, CancellationToken cancellationToken = default, long timeOutSeconds = 100);
    ...
    Task<string> ExportSurveyAccessCodeAsync(string record, string instrument, string eventName, int repeatInstance, RedcapReturnFormat returnFormat = RedcapReturnFormat.json, CancellationToken cancellationToken = default, long timeOutSeconds = 100);
    ...
    Task<string> ExportSurveyParticipantsAsync(string instrument, string eventName, RedcapFormat format = RedcapFormat.json, RedcapReturnFormat returnFormat = RedcapReturnFormat.json, CancellationToken cancellationToken = default, long timeOutSeconds = 100);
    ...
    Task<string> ExportSurveyQueueLinkAsync(string record, RedcapReturnFormat returnFormat = RedcapReturnFormat.json, CancellationToken cancellationToken = default, long timeOutSeconds = 100);
    ...
    Task<string> ExportSurveyReturnCodeAsync(string record, string instrument, string eventName, string? repeatInstance, RedcapReturnFormat returnFormat = RedcapReturnFormat.json, CancellationToken cancellationToken = default, long timeOutSeconds = 100);
}
