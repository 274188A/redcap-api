...
{
    /// <summary>
    /// REDCap users API contract.
    /// </summary>
    public interface IRedcapUsers
    {
        /// <summary>
        ...
        Task<string> DeleteUsersAsync(List<string> users, Content content = Content.User, RedcapAction action = RedcapAction.Delete, CancellationToken cancellationToken = default, long timeOutSeconds = 100);
        ...
        Task<string> ImportUsersAsync<T>(List<T> data, RedcapFormat format = RedcapFormat.json, RedcapReturnFormat returnFormat = RedcapReturnFormat.json, CancellationToken cancellationToken = default, long timeOutSeconds = 100);
    }
}
