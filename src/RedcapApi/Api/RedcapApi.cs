...
namespace Redcap
{
    ...
    public class RedcapApi : IRedcap
    {
        ...
        public async Task<string> ExportDagsAsync(string token, RedcapFormat format = RedcapFormat.json, RedcapReturnFormat returnFormat = RedcapReturnFormat.json, CancellationToken cancellationToken = default, long timeOutSeconds = 100)
        {
            return await ExecuteAsync(token, payload =>
            {
                payload["token"] = token;
        ...
        public async Task<string> ImportDagsAsync<T>(string token, RedcapFormat format, List<T> data, RedcapReturnFormat returnFormat = RedcapReturnFormat.json, CancellationToken cancellationToken = default, long timeOutSeconds = 100)
        {
        ...
        public async Task<string> DeleteDagsAsync(string token, string[] dags, CancellationToken cancellationToken = default, long timeOutSeconds = 100)
        {
            return await ExecuteAsync(token, payload =>
            {
                if (dags.Length < 1)
        ...
        public async Task<string> SwitchDagAsync(string token, RedcapDag dag, CancellationToken cancellationToken = default, long timeOutSeconds = 100)
        {
            return await ExecuteAsync(token, payload =>
            {
                payload["token"] = token;
        ...
        public async Task<string> ExportUserDagAssignmentAsync(string token, RedcapFormat format = RedcapFormat.json, RedcapReturnFormat returnFormat = RedcapReturnFormat.json, CancellationToken cancellationToken = default, long timeOutSeconds = 100)
        {
            return await ExecuteAsync(token, payload =>
            {
                payload["token"] = token;
        ...
        public async Task<string> ImportUserDagAssignmentAsync<T>(string token, RedcapFormat format, List<T> data, RedcapReturnFormat returnFormat = RedcapReturnFormat.json, CancellationToken cancellationToken = default, long timeOutSeconds = 100)
        {
            var _serializedData = JsonConvert.SerializeObject(data);
            return await ExecuteAsync(token, payload =>
            {
